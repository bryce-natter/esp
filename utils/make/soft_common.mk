...
soft-build:
	...
	@ln -sf $(DRV_LINUX)/prc/* $(BUILD_DRIVERS)/prc
...
$(SOFT_BUILD)/sysroot/opt/drivers-esp/prc.ko: $(SOFT_BUILD)/linux-build/vmlinux $(wildcard $(ESP_CORE_PATH)/*.c) $(wildcard $(ESP_CORE_PATH)/*.h) $(wildcard $(DRV_LINUX)/include/*.h)
	@mkdir -p $(SOFT_BUILD)/sysroot/opt/drivers-esp
